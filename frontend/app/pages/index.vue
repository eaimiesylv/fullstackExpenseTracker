  ...
  meta: [
    {
      name: 'description',
      content:
        'The all-in-one finance platform for individuals and groups. Budgets, bill splitting, and automated Ajo/Esusu, all in one ledger.',
    },
  ],
  link: [
    ...
    {
      rel: 'stylesheet',
      href: 'https://fonts.bunny.net/css?family=space-grotesk:500,600,700|inter:400,500,600,700|jetbrains-mono:400,500,600&display=swap',
    },
  ],
  htmlAttrs: {
    lang: 'en',
  ...
  <div class="antialiased">
        ...
        <div class="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
          <div class="max-w-3xl">
            ...
            <p class="mt-6 text-lg leading-relaxed text-slate-600">
              This app helps people manage personal money and group money in one simple place. Create budgets,
              record expenses, split payments, track who has paid, and keep contributing together like Ajo or
              Esusu.
            </p>
            ...
            <div class="mt-8 flex flex-wrap items-center gap-4">
              <a
                href="#start"
                class="grad-cta rounded-full px-7 py-3.5 text-base font-semibold text-white shadow-md shadow-emerald-200 transition hover:brightness-105"
              >
                Get Started
              </a>
              <a
                href="#features"
                class="rounded-full border border-slate-300 px-6 py-3.5 text-base font-semibold text-slate-700 transition hover:bg-slate-50"
              >
        ...
        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          <div class="receipt-card p-6">
            ...
            <p class="mt-2 text-sm leading-relaxed text-slate-600">
              Set spending limits, track what is left, and keep your money under control.
            </p>
          </div>
          ...
          <div class="receipt-card p-6">
            ...
            <p class="mt-2 text-sm leading-relaxed text-slate-600">
              Record every expense and see where money is going in real time.
            </p>
          </div>
          ...
          <div class="receipt-card p-6">
            ...
            <p class="mt-2 text-sm leading-relaxed text-slate-600">
              Add who owes, split the amount fairly, and see who has paid and who is still pending.
            </p>
          </div>
          ...
          <div class="receipt-card p-6">
            ...
            <p class="mt-2 text-sm leading-relaxed text-slate-600">
              Create fixed contributions for everyone, or keep saving together like Ajo / Esusu.
            </p>
          </div>
        </div>
      </section>
        ...
        <div class="grid gap-10 lg:grid-cols-2">
          <div class="receipt-card p-8">
            ...
            <p class="mt-4 text-slate-600">
              In a group, only the creator can manage and edit by default. Other members can be read-only,
              everyone can write, or each person can be given specific permissions.
            </p>
          ...
          <div class="receipt-card p-8">
            ...
            <p class="mt-4 text-slate-600">
              You can create a shared expense and assign who owes what. You can also create fixed amounts for
              every member to pay, then track who has paid and who is still outstanding.
            </p>
            <ul class="mt-6 space-y-3 text-sm text-slate-600">
      ...
      <section id="start" class="grad-final py-20">
        <div class="mx-auto max-w-3xl px-6 text-center">
          <h2 class="font-display text-3xl font-bold tracking-tight text-white sm:text-4xl">
            Start with the basics: budget, spend, share, and contribute.
          </h2>
    ...
    <footer class="border-t border-slate-200 bg-white py-10">
      <div class="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-6 text-sm text-slate-400 sm:flex-row">
        <span>© {{ currentYear }} LedgerFlow. All rights reserved.</span>
